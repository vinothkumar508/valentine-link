      ...
      <div className="w-full max-w-lg space-y-8">
        <header className="text-center">
          ...
          <p className="text-stone-600 mt-1 text-sm">
            Personalize the message and share the link with your special someone.
          </p>
        </header>
        ...
        <Card className="space-y-5">
          ...
          <div>
            ...
            <p className="text-xs text-stone-500 mb-2">Only https:// links are accepted. Empty fields are ignored.</p>
        ...
        <Card className="border-2 border-dashed border-rose-200/60">
          ...
          <div className="space-y-1 text-stone-700 prose-break">
            ...
            <p className="text-lg font-medium text-stone-800">{msg || 'Will you be mine?'}</p>
            <p className="text-sm">
              From <span className="font-medium">{from || '…'}</span>
            </p>
            {validImgs.length > 0 && (
              <p className="text-xs text-stone-500">{validImgs.length} image(s) will show after &quot;Yes&quot;</p>
            )}
          </div>
        </Card>
        ...
        <Card padding="md" className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button variant="primary" onClick={handleCopy} aria-label="Copy link">
              Copy
            </Button>
          </div>
          <p className="text-xs text-stone-500">
            Share this link. When they open it and tap &quot;Yes&quot;, they&apos;ll see your message
            {validImgs.length > 0 ? ' and photos.' : '.'}
          </p>
        </Card>
        </div>
